...
public class HealthCheckExecutorService {
    ...
    /**
     * Performs the HTTP health check and returns a Spring Health object.
     * It uses RestTemplate to send a GET request to the URL defined in the config.     *
     * If the HTTP status code is 2xx, it builds a Health.up() response.
     */
